  ...
  return (
    <div className="flex items-center justify-center">
      <div
        ...
        className="rounded-3xl w-[1333px] h-auto lg:mx-[150px] mx-[20px] sm:mx-[20px] md:mx-[30px] mt-[78px] mb-[100px] p-[35px] lg:p-20 text-justify"
      >
        ...
        <p>
          We are Barika and Vihanna Private Limited, doing business as Grazle
          (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
          &quot;our&quot;), a company
        </p>
        <p>
          registered in India at P.no.a-211, 212,144, blk-a, Kh No.414, 02nd
          Floor, Mahipalpur, South West Delhi, New Delhi, Delhi
        </p>
        <p>110037.</p>
        <p>
          ...
          <a
            ...
            className="text-blue-500"
            href="http://www.grazle.co.in"
          >
            http://www.grazle.co.in
          </a>{" "}
          (the &quot;Site&quot;), the mobile application Grazle (the
        ...
        <p>
          You can contact us by phone at +91 910-820-2334, email at{" "}
          <a className="text-blue-500" href="mailto:support@grazle.com">
            support@grazle.com
          </a>
          ,{" "}
          <a className="text-blue-500" href="mailto:grazlehomeware@gmail.com">
            grazlehomeware@gmail.com
          </a>
        </p>
        <p>to</p>
        <p>
        ...
        <p>
          ...
          <a className="text-blue-500" href="mailto:support@grazle.co.in">
            support@grazle.co.in
          </a>{" "}
          or{" "}
          <a className="text-blue-500" href="mailto:grazlehomeware@gmail.com">
            grazlehomeware@gmail.com
        ...
        <p>
          ...
          (generally under the age of 18) must have the permission of,
        </p>
        <p>
        ...
        <p>
          ...
          part of the Services and no Content or Marks may be
        </p>
        <p>
        ...
        <p>
          ...
          than as set out in this section or elsewhere in our
        </p>
        <p>
        ...
        <p>posting, reproducing, or displaying our Content.</p>
        <p>
        ...
        <p>
          ...
          material breach of our Legal Terms and your right to use
        </p>
        <p>our Services will terminate immediately.</p>
        ...
        <p>
          the (a) rights you give us and (b) obligations you have when you post
        ...
        <p>
          ...
          publish, broadcast, re-title, store, publicly perform, publicly
          ...
          works, your Contributions, and to sub-license the licenses granted in
        ...
        <p>
          &bull; Trick, defraud, or mislead us and other users, especially in
        ...
        <p>
          ...
          clear graphics interchange formats (&quot;gifs&quot;), 1x1 pixels, web
        ...
        <p>
          ...
          reproduce, disclose, sell, resell, publish, broadcast, re-title,
        ...
        <p>
          ...
          (1) to edit, redact, or otherwise change any Contributions; (2) to re-
          categorize any Contributions to place them in more appropriate
        ...
        <p>By using the Services, you agree</p>
        <p>
          to be bound by our Privacy Policy, which is incorporated into these
          Legal Terms. Please be advised the Services are hosted in India. If
        ...
        <p>
          ...
          be three (3). The seat, or legal place, or arbitration shall be Delhi,
