      ...
      <div className="flex flex-col justify-center items-center w-full max-w-[400px] h-auto p-8 bg-white rounded-lg shadow-lg">
        ...
        {paymentDetails && (
          <div className="text-sm text-gray-500 mb-4">
            ...
            <p>Status: {paymentDetails.order_status}</p>
            <p>Date: {paymentDetails.trans_date}</p>
            {paymentDetails.payment_mode && <p>Payment Mode: {paymentDetails.payment_mode}</p>}
            {paymentDetails.bank_ref_no !== "null" && <p>Bank Reference: {paymentDetails.bank_ref_no}</p>}
          </div>
        )}
        <button
